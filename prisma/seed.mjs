...
async function seedQuestionaire() {

  let questionaires = Object.values(QUESTIONAIRES).reduce((total, currentValue, currentIndex, array) => {
    total.push({
  ...
  await prisma.questionaire.createMany({
    data: questionaires
  })
}
